...
function showFuelCost() {
  fuelCost.petrol = Math.round(
    (cityMileage.value * fuelConsumption.petrol.city +
      motorwayMileage.value * fuelConsumption.petrol.motorway) *
      fuelPrice
  );
  fuelCost.hybrid = Math.round(
    (cityMileage.value * fuelConsumption.hybrid.city +
      motorwayMileage.value * fuelConsumption.hybrid.motorway) *
      fuelPrice
  );
